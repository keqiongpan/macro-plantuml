...
{
    private static final Logger LOGGER = LoggerFactory.getLogger(PlantUMLMacro.class);
        ...
        throws MacroExecutionException
    {
        ...
        LOGGER.warn("serverUrl: {}", serverUrl);
        LOGGER.warn("imageFormat: {}", imageFormat);
        ...
        LOGGER.warn("Output image file path: {}", imageFile.getPath());
        LOGGER.warn("Output image file size: {}", imageFile.length());
        ...
        if ((ImageFormat.svg.name().equals(imageFormat) && !parameters.isImageTag()) || ImageFormat.txt.name().equals(imageFormat)) {
            ...
            LOGGER.warn("Read image file content length: {}", imageContent.length());
